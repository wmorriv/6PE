...
```
                       MPLS Core (IPv4 / IS-IS / SR)
              ┌──────────────────────────────────────────┐
              │                                          │
              │    10.10.10.0/31          10.10.10.4/31   │
   ┌─────┐    │  ┌──────┐  et1────et1  ┌──────┐         │    ┌─────┐
   │ CE1 ├──et3──┤ PE01 ├──────────────┤  P1  │         │  et3─┤ CE2 │
   └─────┘    │  └──┬───┘             └──┬───┘         │    └─────┘
              │     │ et2                 │ et2          │
              │     │ 10.10.10.2/31       │ 10.10.10.4/31│
              │     │                     │              │
              │     │ 10.10.10.3/31       │ 10.10.10.7/31│
              │     │ et2                 │ et1          │
              │  ┌──┴───┐             ┌──┴───┐         │
              │  │  P2  ├──────────────┤ PE02 ├──et3────┘
              │  └──────┘  et1────et2  └──────┘
              │    10.10.10.6/31          10.10.10.6/31   │
              └──────────────────────────────────────────┘
```
